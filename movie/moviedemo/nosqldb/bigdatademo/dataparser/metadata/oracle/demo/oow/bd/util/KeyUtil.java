...
public class KeyUtil {
     ...
     * @see CastTO
     */
    public static Key getCastInfoKey(int castId) {
        ...
        if (castId > 0) {
            ...
            minorComp = new ArrayList<String>();

            //Add Major component
            majorComp.add(prefix);
            majorComp.add(String.valueOf(castId));

            //Add Minor component
            minorComp.add(KeyConstant.INFO_COLUMN);
            key = Key.createKey(majorComp, minorComp);
        } //if (castId > 0) {
        return key;
    } //getCastInfoKey
     ...
     * @see CrewTO
     */
    public static Key getCrewInfoKey(int crewId) {
        ...
        if (crewId > 0) {
            ...
            //Add Major component
            majorComp.add(prefix);
            majorComp.add(String.valueOf(crewId));
     ...
     * @see CastCrewTO
     */
    public static Key getMovieCastCrewKey(int movieId) {
        ...
        if (movieId > 0) {
            ...
            //Add Major component
            majorComp.add(prefix);
            majorComp.add(String.valueOf(movieId));

            key = Key.createKey(majorComp, KeyConstant.CAST_CREW_COLUMN);
     ...
     */
    public static Key getGenreNameKey(String genreName) {
        Key key = null;

        if (StringUtil.isNotEmpty(genreName)) {
            List<String> majorComponent = new ArrayList<String>();
            majorComponent.add(KeyConstant.GENRE_TABLE);
            majorComponent.add(genreName.toLowerCase());
     ...
     */
    public static Key getMovieIdKey(int movieId) {
        Key key = null;
     ...
     * @return
     */
    public static Key getMovieNameKey(String movieName, int movieId) {
        Key key = null;
     ...
     * @return Key
     */
    public static Key getCustomerGenresKey(int custId) {
        Key key = null;

        List<String> majorComponent = new ArrayList<String>();
        majorComponent.add(KeyConstant.CUSTOMER_TABLE);
        majorComponent.add(Integer.toString(custId));
        key = Key.createKey(majorComponent, KeyConstant.GENRE_COLUMN);
     ...
     * @return Key
     */
    public static Key getCustomerGenreMovieKey(int custId, int genreId,
                                               int movieId) {
        Key key = null;

        if (genreId > 0) {
            List<String> majorComponent = new ArrayList<String>();
            majorComponent.add(KeyConstant.CUSTOMER_GENRE_MOVIE_TABLE);
            majorComponent.add(Integer.toString(custId));
            majorComponent.add(Integer.toString(genreId));
     ...
     * @return Key
     */
    public static Key getCustomerMovieKey(int custId, int movieId) {
        Key key = null;

        if (custId > 0 && movieId > 0) {
            List<String> majorComponent = new ArrayList<String>();
            majorComponent.add(KeyConstant.CUSTOMER_MOVIE_TABLE);
            majorComponent.add(Integer.toString(custId));
     ...
     */
    public static Key getCommonWatchListKey() {
        Key key = null;
        ...
        List<String> majorComponent = new ArrayList<String>();
        majorComponent.add(KeyConstant.COMMON_CURRENT_WATCH_LIST);
        majorComponent.add(yyyyMMdd);

        key = Key.createKey(majorComponent, Long.toString(timeStamp));
     ...
     */
    public static Key getCustomerBrowseListKey(int custId, int movieId) {
     ...
     */
    public static Key getCustomerCurrentWatchListKey(int custId, int movieId) {
     ...
     */
    public static Key getCustomerHistoricalWatchListKey(int custId,
                                                        int movieId) {
        return getCustomerBrowseKey(custId,
     ...
     */
    private static Key getCustomerBrowseKey(int custId, String tableName,
                                            int movieId) {
        Key key = null;
        ...
        if (custId > 0) {
            ...
            if (movieId > 0)
                key = Key.createKey(majorComponent, Long.toString(movieId));
            else
                key = Key.createKey(majorComponent);
        } //if (custId > 0 )
