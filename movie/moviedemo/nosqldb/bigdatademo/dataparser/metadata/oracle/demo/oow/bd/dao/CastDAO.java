...
public class CastDAO extends BaseDAO {
    ...
    private Schema castSchema = null;
    private JsonAvroBinding castBinding = null;


    public CastDAO() {
        super();        
        castSchema = parser.getTypes().get("oracle.avro.Cast");        
        castBinding = catalog.getJsonBinding(castSchema);
    }
