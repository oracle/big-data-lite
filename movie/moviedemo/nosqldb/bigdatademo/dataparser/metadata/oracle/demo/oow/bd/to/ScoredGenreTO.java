...
public class ScoredGenreTO implements Comparable<ScoredGenreTO> {
    private int id;
    private int score;
    private String name;
    ...
    public ScoredGenreTO(String genreJsonTxt) {
        super();
        try {
            scoredGenreNode = (ObjectNode)jsonMapper.readTree(genreJsonTxt);
    ...
    public ObjectNode getJsonObject() {
        scoredGenreNode = new ObjectNode(factory);
