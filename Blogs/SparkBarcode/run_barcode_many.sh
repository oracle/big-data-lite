...
spark-submit --class "BarcodeApp" --jars ../SimpleJavaApp/lib/core-3.2.1.jar,../SimpleJavaApp/lib/javase-3.2.1.jar target/scala-2.10/scala-zxing-barcode-application_2.10-1.0.jar barcode/images
